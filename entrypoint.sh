...
MODULES="pierinelli_branding,pierinelli_data,pierinelli_pe,pierinelli_reportes,pierinelli_almacenes,pierinelli_planchas,pierinelli_mcp_inventario,pierinelli_contabilidad_operativa,web_responsive,crm,account_edi,stock_landed_costs"
